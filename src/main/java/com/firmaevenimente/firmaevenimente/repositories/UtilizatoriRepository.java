...
public class UtilizatoriRepository {
    ...
    public List<Utilizator> GetUtilizatori(){
        ...
        String sql = "select a.ID_UTILIZATOR, a.ID_NIVEL_ACCES, a.NUME, a.PRENUME, a.NUMAR_TELEFON, a.ADRESA_MAIL, a.NUMAR_EVENIMENTE_CREATE, a.USERNAME, a.PAROLA, b.ROL from utilizatori a join TIP_UTILIZATORI b on a.ID_NIVEL_ACCES = b.ID_NIVEL_ACCES";
